export const ME = {
  ...
  summary:
    "I design and build e-commerce sites and digital products, from early direction to launch. Most of my work sits between design and development, so I tend to stay involved in the whole process. I've shipped stores, interfaces, and platforms for clients in the US, Europe, and Latin America.",
  socials: {
...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    tag: "client",
    blurb: "Shopify storefront refresh for a combat-sports apparel brand: new homepage, reorganized sections, and a cleaner shop and product pages.",
...
export const EXPERIENCE: Job[] = [
  {
    ...
    location: "",
    period: "2023 - Present",
    blurb: "I design and build websites and online stores for clients and small teams in the US, Europe, and Latin America, from the first layout to launch, set up so they can update their own content. I also handle hosting, domains, email, and maintenance.",
  },
  {
    title: "UI Designer",
